			...
			jButtonStop.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					getDevice().SetAllPIDSetPoint(
							getKinematicsGUI().getCurrentValues(), 0);
				}
			});
		}
		return jButtonStop;
		...
		if (jButtonDesiredNeedleRAS == null) {
			...
			jButtonDesiredNeedleRAS.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					//TODO fill in set joint values here
//					getKinematicsGUI().setTargetValues(target);
//					getKinematicsGUI().runTargetJointUpdate(1000);
				}
			});
		}
